...
PROGRAM_VERSION_VERSION = 'v1.0.1'
PROGRAM_VERSION_DATE = '2013-04-05'
...
NEXIF_SATURATION_LOWER = [x.lower() for x in NEXIF_SATURATION]
NEXIF_SHARPNESS_LOWER = [x.lower() for x in NEXIF_SHARPNESS]
NEXIF_WHITE_BALANCE_LOWER = [x.lower() for x in NEXIF_WHITE_BALANCE]
