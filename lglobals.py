...
DEFAULT_ENGINE = 1
DO_NOT_USE_INTERNAL_RESOURCE = False
DO_NOT_USE_NEPOMUK = False
if DO_NOT_USE_INTERNAL_RESOURCE:
    INTERNAL_RESOURCE = INTERNAL_RESOURCE_FORCED_IN_CONSOLE = INTERNAL_RESOURCE_IN_PLAYLIST = INTERNAL_RESOURCE_IN_RESULTS_LIST = USE_INTERNAL_RESOURCE_FOR_MAIN_TYPE = False

else:
    INTERNAL_RESOURCE = (True or DO_NOT_USE_NEPOMUK)
    INTERNAL_RESOURCE_FORCED_IN_CONSOLE = (True or DO_NOT_USE_NEPOMUK)
    INTERNAL_RESOURCE_IN_PLAYLIST = (True or DO_NOT_USE_NEPOMUK)
    INTERNAL_RESOURCE_IN_RESULTS_LIST = (True or DO_NOT_USE_NEPOMUK)
